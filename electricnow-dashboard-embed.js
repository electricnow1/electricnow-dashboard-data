...
window.ELECTRICNOW_DASHBOARD_DATA = {
  ...
  "adSuccessSummary": {
    ...
    "period": "Sep 14-Sep 20, 2026",
    "verdict": "Roku too expensive; content-led Meta test needs retention proof",
    "plainEnglish": "Verdict: Roku acquisition is too expensive on the agency's reported evidence; content-led Meta tests need proof of retention. (1) Roku ads have been running for several weeks, but Nathan reports no expected TV-app audience growth. Google shows no Sep 14–20 delivery; current Meta delivery totals remain unavailable. (2) Roku's best campaign costs over $60/install on $1,908 campaign-to-date spend: concerning and unsustainable per Nathan. Historical Meta blended cost was $11.31/download; initial app-prospecting efficiency was better according to Nathan, but weak retention prevents declaring sustainable acquisition economics. (3) No fresh age/gender/device report establishes improving targeting; use separate iOS/Android and cold-interest/retargeting tests. (4) Nathan favors Meta's audience controls over Roku; that is a recommended next test, not verified current outperformance. (5) Nathan reports weak post-install retention; GA4's 21 paid-tagged sessions do not attribute store installs to viewing or sales. True ROAS cannot be stated without reconciled revenue. (6) Review pausing Roku rather than chasing the conditional credit; test show-led Meta cuts, track first play and seven-day return, and scale only audiences that actually watch.",
    "recommendations": [
      "Patrick and Nathan: review pausing or capping Roku; obtain exact flight dates, campaign-level spend/install counts and credit terms before any further commitment. No campaign or budget has been changed by this dashboard update.",
      "Breana, Emma, Sydney and Christina: create 15- and 30-second Ark cuts with the explicit free-streaming/app-install CTA; test against the general ElectricNOW sizzle and then Leverage/Librarians variants.",
      "Patrick and Nathan: separate cold-interest from retargeting audiences and iOS from Android; compare cost per first play and seven-day return, not just installs.",
      "Michael: verify deep links and install-to-show attribution, confirm creative availability/rights, and reconcile Ionic ad revenue before scaling.",
      "Perplexity: track Roku Ads separately from Roku App Engagement, sales and TRC; preserve the fixed launch baseline and label campaign-to-date versus weekly results."
    ],
    ...
    "status": "fresh_roku_agency_update_historical_meta_metrics",
    "freshness": "Sep 21 Nathan update adds Roku campaign-to-date results and qualitative Meta retention feedback. Weekly Meta metrics remain historical.",
    "attemptedPeriod": "Sep 14-Sep 20, 2026",
    "sourceStatus": "mixed_fresh_google_roku_historical_meta",
    "updatedAt": "2026-09-21T21:54:36.484389+00:00",
    "rokuAds": {
  ...
  "metaAdsSummary": {
    ...
    "plainEnglish": "Historical Meta performance only. Nathan recommends shifting from general app promotion to show-led Meta creative for The Ark, Leverage and The Librarians. His Sep 21 follow-up specifies 15- and 30-second Ark social cuts, with the install CTA: “Watch Seasons 1 and 2 on ElectricNOW. Download the app to stream free today.” He reports efficient initial Meta prospecting installs but weak retention; better retention from content-led creative is a test hypothesis, not a measured result.",
    "paidAcquisitionInterpretation": "Verdict: Roku acquisition is too expensive on the agency's reported evidence; content-led Meta tests need proof of retention. (1) Roku ads have been running for several weeks, but Nathan reports no expected TV-app audience growth. Google shows no Sep 14–20 delivery; current Meta delivery totals remain unavailable. (2) Roku's best campaign costs over $60/install on $1,908 campaign-to-date spend: concerning and unsustainable per Nathan. Historical Meta blended cost was $11.31/download; initial app-prospecting efficiency was better according to Nathan, but weak retention prevents declaring sustainable acquisition economics. (3) No fresh age/gender/device report establishes improving targeting; use separate iOS/Android and cold-interest/retargeting tests. (4) Nathan favors Meta's audience controls over Roku; that is a recommended next test, not verified current outperformance. (5) Nathan reports weak post-install retention; GA4's 21 paid-tagged sessions do not attribute store installs to viewing or sales. True ROAS cannot be stated without reconciled revenue. (6) Review pausing Roku rather than chasing the conditional credit; test show-led Meta cuts, track first play and seven-day return, and scale only audiences that actually watch.",
  ...
  "plainEnglishSummary": {
    ...
    "paidAcquisitionAssessment": {
      "verdict": "Roku too expensive; content-led Meta test needs retention proof",
      "summary": "Verdict: Roku acquisition is too expensive on the agency's reported evidence; content-led Meta tests need proof of retention. (1) Roku ads have been running for several weeks, but Nathan reports no expected TV-app audience growth. Google shows no Sep 14–20 delivery; current Meta delivery totals remain unavailable. (2) Roku's best campaign costs over $60/install on $1,908 campaign-to-date spend: concerning and unsustainable per Nathan. Historical Meta blended cost was $11.31/download; initial app-prospecting efficiency was better according to Nathan, but weak retention prevents declaring sustainable acquisition economics. (3) No fresh age/gender/device report establishes improving targeting; use separate iOS/Android and cold-interest/retargeting tests. (4) Nathan favors Meta's audience controls over Roku; that is a recommended next test, not verified current outperformance. (5) Nathan reports weak post-install retention; GA4's 21 paid-tagged sessions do not attribute store installs to viewing or sales. True ROAS cannot be stated without reconciled revenue. (6) Review pausing Roku rather than chasing the conditional credit; test show-led Meta cuts, track first play and seven-day return, and scale only audiences that actually watch.",
      "period": "Sep 14-Sep 20, 2026",
      "status": "fresh_roku_agency_update_historical_meta_metrics",
  ...
  "sourceStatus": {
    ...
    "rokuAds": {
      ...
      "source": "Nathan Froelich / PC Digital Marketing email",
      "updatedAt": "2026-09-21T21:54:36.484389+00:00",
      "note": "Campaign-to-date, not weekly. Agency-reported, not a reconciled platform export."
    }
  },
  "refreshAuditNotes": [
  ...
  "lastUpdated": "September 21, 2026 (Pacific); Nathan campaign update included",
  "lastUpdatedIso": "2026-09-21T21:54:36.484389+00:00",
  "generatedAtIso": "2026-09-21T21:54:36.484389+00:00",
  ...
  "campaignSummary": {
    ...
    "note": "Numeric campaign names are unresolved GA4 tags. Nathan confirmed Roku advertising in a Sep 21 email; this does not resolve Meta campaign names or prove current Meta spend. Do not classify all tagged sessions as residual."
  },
