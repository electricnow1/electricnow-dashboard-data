(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    "generatedAt": "2026-06-09 07:10 PDT",
    ...
    "plainEnglishInsights": [
      ...
      "Visible platform sales increased to $841.55 across 45 visible purchases after adding two new Roku purchases from Jun 4 and Jun 7. Stripe was disconnected during this refresh, so the dashboard preserved the last successful Stripe total instead of zeroing it.",
    ...
    "salesSummary": {
      ...
      "sourceBreakout": [
        {
          ...
          "detail": "Stripe connector is currently disconnected in this run, so the dashboard preserved the last successful Stripe value rather than zeroing it."
        },
        {
          "source": "Roku",
          "purchases": 16,
          "purchaseRevenue": 241.84,
          "developerRevShare": 193.44,
          "detail": "Roku-visible sales from emailed Sales Activity Reports, including two new June purchases from the Jun 8 report."
        },
        {
          "source": "Apple App Store",
          "purchases": 8,
          "purchaseRevenue": 159.92,
          "developerRevShare": 111.94,
          "detail": "Manual Apple App Store snapshot preserved until a newer screenshot/API integration replaces it."
        }
      ],
      "baselineWindow": {
        "label": "Launch baseline",
      ...
      "note": "Visible platform sales combine Stripe, Roku, and preserved manual Apple snapshots. Stripe was disconnected during the Jun 8 refresh, so last-good Stripe values were preserved. Google Play and other channels may still be missing."
    },
    "contentUsage": {
    ...
    "googleAdsSummary": {
      ...
      "dataFreshnessNote": "Fresh Google Ads connector pull for Jun 1-Jun 7, 2026.",
      "statusDetail": "Fresh as of the June 8 dashboard refresh.",
      "lastSuccessfulPull": "2026-06-08 12:55 PDT"
    },
    "adSuccessSummary": {
      "googleAds": {
