(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    ...
    "plainEnglishInsights": [
      "Overall, ElectricNOW is slightly softer this week on measured platform audience: 7,552 GA4 platform active users for Jun 1-Jun 7, excluding landing-page acquisition traffic, -2.7% versus the previous complete week and -13.3% versus launch week. Viewing-event users were 2,570, -7.9% week over week, so the story is not a collapse, but it is a modest weekly decline that needs continued acquisition and conversion attention.",
      ...
      "Roku app engagement is now updated from the Jun 8 Roku email: 228 new installs, 255 average daily viewers, 74.4 average minutes per viewer, and 2,218 total hours streamed for May 31-Jun 6.",
