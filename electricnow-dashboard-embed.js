(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    "generatedAt": "2026-06-11 14:40 PDT",
    ...
    "plainEnglishInsights": [
      "Overall (June 11, 2026 refresh): GA4 complete-week usage remains Jun 1-Jun 7, 2026 because Jun 11 is mid-week and the next Mon-Sun week (Jun 8-14) is not complete yet, so platform-usage windows are intentionally held at the last complete week. Measured platform audience was 7,552 GA4 active users for Jun 1-Jun 7 (excluding landing-page acquisition), -2.7% vs the previous complete week. New this run: Apple downloads and sales were updated through Jun 10 (a Jun 10 Purchase HD 15 sale, plus a Jun 4-10 downloads snapshot of 1,053). Roku App Engagement is stale this run - a newer Jun 11 report arrived but its PDF attachment could not be retrieved, so the last good May 31-Jun 6 values are preserved (not zeroed). Paid acquisition is current to each source: Meta May 31-Jun 6 and Google Ads Jun 1-Jun 7.",
      ...
      "Visible platform sales (combined Stripe, Roku, and the manual Apple App Store snapshot): 46 purchases and $856.54 year to date - Stripe 21/$439.79, Roku 16/$241.84 ($193.44 developer revenue share), and Apple 9/$174.91 ($122.43 est. net), now including the Jun 10 Apple Purchase HD 15 ($14.99). This is still not total ElectricNOW sales: Google Play is handled separately and Apple is a manual snapshot.",
    ...
    "salesSummary": {
      ...
      "apple": {
        ...
        "snapshotRange": "Manual Apple App Store screenshots through Jun 10, 2026",
        "platformFeePct": 30,
        "estimatedNetPct": 70,
        "baselineWindow": {
        ...
        "yearToDate": {
          ...
          "range": "Jan 1-Jun 11, 2026",
          "purchases": 9,
          "purchaseRevenue": 174.91,
          "developerRevShare": 122.43,
          "revenuePerPurchase": 19.43,
          "payments": [
            {
              "date": "Apr 16",
              "amount": 29.98,
        ...
        "note": "Apple App Store screenshots show $174.91 gross in-app purchase sales manually entered so far, or approximately $122.43 after Apple’s 30% platform fee. Includes the Jun 10, 2026 Purchase HD 15 ($14.99) from the latest App Store Connect screenshot. These figures remain manual until Apple App Store Connect API reporting is connected."
      },
      "sourceBreakout": [
        {
          "source": "Stripe",
          ...
          "detail": "Stripe-visible succeeded payments. Connector verified live on 2026-06-11; no new payments after 2026-05-28, so the total is current (not stale)."
        },
        {
          "source": "Roku",
          "purchases": 16,
          "purchaseRevenue": 241.84,
          "developerRevShare": 193.44,
          "detail": "Roku-visible sales from the latest emailed Sales Activity Report (Jun 8, 2026); no newer Roku sales report this run."
        },
        {
          "source": "Apple App Store",
          "purchases": 9,
          "purchaseRevenue": 174.91,
          "developerRevShare": 122.43,
          "detail": "Manual Apple App Store snapshot; includes the Jun 10, 2026 Purchase HD 15 ($14.99) from the latest App Store Connect screenshot."
        }
      ],
      "baselineWindow": {
        "label": "Launch baseline",
      ...
      "yearToDate": {
        ...
        "range": "Jan 1-Jun 11, 2026",
        "purchases": 46,
        "purchaseRevenue": 856.54,
        "developerRevShare": 315.87,
        "revenuePerPurchase": 18.62
      },
      "monthToDate": {
        "label": "Sales this month",
        "range": "Jun 1-Jun 11, 2026",
        "purchases": 3,
        "purchaseRevenue": 49.97,
        "developerRevShare": 38.47,
        "revenuePerPurchase": 16.66,
        "payments": [
          {
            "date": "Jun 10",
            "amount": 14.99,
      ...
      "note": "Visible platform sales show 46 purchases and $856.54 year to date, combining Stripe-visible payments, Roku-visible sales, and the manual Apple App Store snapshot. Apple gross in the snapshot is $174.91 (est. net $122.43 after Apple’s 30% fee). Still not total ElectricNOW sales: Google Play is separate and Apple is a manual snapshot."
    },
    "contentUsage": {
    ...
    "manualAppleSalesUpdate": {
      "updatedAt": "2026-06-11T21:33:00+00:00",
      "source": "manual_apple_sales.json updated with Jun 10 sale; preserved across refresh",
      "totalManualAppleEntries": 5,
      "note": "5 manual entries: May 13, May 18 (2), May 25, Jun 10 (Purchase HD 15, $14.99 gross)."
    },
    "googleAdsSummary": {
    ...
    "manualAppleDownloads": {
      ...
      "capturedAt": "2026-06-11 14:33 PDT",
      "enteredAt": "2026-06-11 14:40 PDT",
      "uploadedAttachments": [
        "uploaded_attachments/938fa56def2e4d469759f715c8770513/image-1.jpeg"
      ],
      "product": "ElectricNOW",
      "platform": "Free iOS/watchOS/tvOS",
      "period": "Jun 4-Jun 10, 2026",
      "start": "2026-06-04",
      "end": "2026-06-10",
      "downloads": 1053,
      "displayDownloads": "1,053",
      "dailyAverage": 150,
      "daily": [
        {
          "date": "2026-06-04",
      ...
      "note": "Manual Apple Connect screenshot. Daily U.S. downloads total 1,053 for Jun 4-Jun 10, 2026 (June 10 = 133). Preserved until replaced by a newer screenshot or an Apple App Store Connect API integration."
    },
    "manualDataPatch": {
    ...
    "plainEnglishSummary": {
      "generatedAt": "2026-06-11 14:40 PDT",
      "overview": "As of the June 11, 2026 refresh, ElectricNOW's GA4 complete-week usage still reflects June 1-June 7, 2026: because June 11 falls mid-week, the next Monday-Sunday week (June 8-14) is not yet complete, so the platform-usage windows are intentionally held at the last complete week rather than showing a partial one. What did change this run is on the Apple side: manual App Store Connect downloads and sales were updated through June 10 (a new June 10 Purchase HD 15 sale of $14.99, plus a June 4-10 downloads snapshot). Roku App Engagement is shown as stale this run because a newer June 11 report arrived but its PDF attachment bytes could not be retrieved, so the last good May 31-June 6 values are preserved (not zeroed). Paid-acquisition data is current to each source's latest complete window: Meta May 31-June 6, 2026 and Google Ads June 1-June 7, 2026.",
      "bullets": [
        "Traffic: platform visits (GA4 sessions, excluding landing-page acquisition) were 13,821 in the current complete week (Jun 1-Jun 7), -3.7% vs the previous 7 days. Over the latest complete 28 days (May 11-Jun 7) visits were 56,406, +6.3% vs the prior 28 days.",
        ...
        "App downloads (Apple manual snapshot): 1,053 downloads for Jun 4-Jun 10, 2026 (June 10 = 133). This is App Store download activity, not paid sales and not GA4 active users.",
        "Sales (visible platform sales = Stripe + Roku + manual Apple): 46 purchases and $856.54 year to date - Stripe 21/$439.79, Roku 16/$241.84, and Apple 9/$174.91 gross (est. net $122.43 after Apple's 30% fee), now including the June 10 Apple Purchase HD 15 ($14.99).",
        "Caveats: Apple figures are a manual App Store Connect snapshot (gross shown; estimated net assumes Apple keeps 30%); Google Play sales are handled separately and are not in this total; Roku App Engagement is stale this run pending a retrievable June 11 report; GA4 in-app-purchase signals are usage signals, not booked revenue, and are excluded from visible platform sales.",
        "Bottom line: usage is steady on the last complete week with no regression, paid spend keeps buying installs at reasonable cost, and visible sales rose to 46/$856.54 with the new Apple sale. The open item is still proving downstream viewing depth from paid installs, plus refreshing Roku App Engagement once its attachment is available."
      ]
    }
  };
