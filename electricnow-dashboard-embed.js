(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    "generatedAt": "2026-07-03 11:30 PDT",
    ...
    "scorecards": [
      ...
      },
      {
        ...
        "deltaType": "points",
        "format": "percent",
        "context": "Engaged app-stream sessions divided by app-stream sessions (GA4 property 497892271, Jun 22-28, 2026). The weekly figure dips only because of an isolated Sunday Jun 28 GA4 engaged-session classification anomaly (engagedSessions 702 of 2,339) - NOT a real engagement collapse: active users, sessions, views and time-spent all held up or rose that day. Time-spent (+1.8%) is the more reliable attention signal.",
        "currentSourceNote": "Preserved: no fresh GA4 source for this metric in the Jun 8-14 run."
      },
      {
        "key": "viewingEventUsers",
