...
window.ELECTRICNOW_DASHBOARD_DATA = {
  ...
  "scorecards": [
    ...
    },
    {
      ...
      "deltaVsLaunchPct": 81.99909039691985,
    ...
    },
    {
      ...
      "deltaVsLaunchPct": 46.17084050146538,
    ...
    },
    {
      ...
      "deltaVsLaunchPct": 11.448141406841664,
  ...
  "plainEnglishInsights": [
    ...
    "Sales: the newer DotStudios/Michael Johnson TVOD export shows 182 paid title transactions and $3794.08 gross from Jul 5-Aug 3 ($3779.09 after the one refund shown in the export). The older visible-source rollup remains lower at 128 countable purchases and $3360.70 because it only combines Stripe, Roku, and manual Apple snapshots and should be treated as a source-reconciliation subtotal, not the authoritative title-level TVOD total.",
  ...
  "salesSummary": {
    ...
    "note": "Reconciliation note: the DotStudios/Michael Johnson TVOD export is the more complete title-level sales view currently in the dashboard, showing 182 paid title transactions and $3794.08 gross from Jul 5-Aug 3 ($3779.09 after the one refund shown in the export). The visible Stripe/Roku/Apple rollup remains lower at 128 countable purchases and $3360.70 because it is a source-limited subtotal; do not add the two together because they overlap.",
  ...
  "visitSummary": {
    ...
    "monthly": {
      ...
      "deltaVsPreviousPct": -12.258210552308832,
      "comparisonLabel": "vs previous 28 days",
      "rollingWindowLabel": "Rolling 28 days: Jul 6-Aug 2, 2026"
    },
    "note": "Visits are GA4 sessions, not unique people. Weekly visits use the latest 7 complete days and compare against the previous 7 complete days. Monthly visits use the latest rolling 28 complete days and compare against the previous rolling 28 complete days. Landing-page traffic remains acquisition-only and is not included here."
  },
  ...
  "manualDataPatch": {
    ...
    "latestTvodManualExport": {
      "source": "User-provided TVOD transaction CSV pasted in chat on 2026-08-04",
      "periodStart": "2026-07-05",
      "periodEnd": "2026-08-03",
      "paidTransactions": 182,
      "paidNet": 3794.08,
      "arkNet": 2602.74,
      "librariansNet": 1070.45,
      "doubleCountCaveat": "Fresh aggregate TVOD transaction export covering 2026-07-05\u20132026-08-03. This manual section is separate from Stripe/Roku/Apple Visible Platform Sales and should not be summed with salesSummary until transaction-level reconciliation confirms there is no overlap."
    }
  },
  ...
  "plainEnglishSummary": {
    ...
    "connectorStatus": {
      ...
      "YouTube": "CONNECTED",
      "TVOD manual export": "UPDATED_AGGREGATE_2026-08-04"
    }
  },
  "youtubeSummary": {
  ...
  "tvodTitleRevenue": {
    ...
    "periodStart": "2026-07-05",
    "periodEnd": "2026-08-03",
    "periodNote": "Fresh aggregate TVOD transaction export covering 2026-07-05\u20132026-08-03. This manual section is separate from Stripe/Roku/Apple Visible Platform Sales and should not be summed with salesSummary until transaction-level reconciliation confirms there is no overlap.",
    "extractedAt": "2026-08-04T07:37:00-07:00",
    "registeredUsers": {
      "total": 7914,
      "active": 7814
    },
    ...
    "transactions": {
      ...
      "latestSevenDayPaidTransactions": 165
    },
    "netRevenue": {
      "tvodSalesExportPaidGross": 3794.08,
      "tvodSalesExportPaidNet": 3794.08,
      "refundsGross": -14.99,
      "refundsNet": -14.99,
      "netIncludingRefunds": 3779.09,
      "latestSevenDayGross": 3508.3,
      "latestSevenDayNet": 3508.3
    },
    "familyTotals": [
      {
        "family": "The Ark",
    ...
    "titleFamilySummary": {
      ...
      "arkGross": 2602.74,
      "arkNet": 2602.74,
      "arkShareOfPaidTransactionsPct": 66.5,
      "arkShareOfPaidNetPct": 68.6,
      "librariansTransactions": 52,
      "librariansGross": 1070.45,
      "librariansNet": 1070.45,
      "librariansShareOfPaidTransactionsPct": 28.6,
      "librariansShareOfPaidNetPct": 28.2,
      "arkSeason3Transactions": 114,
      "arkSeason3Gross": 2392.86,
      "arkSeason3Net": 2392.86,
      "librariansNextChapterSeason2Transactions": 48,
      "librariansNextChapterSeason2Gross": 1007.52,
      "librariansNextChapterSeason2Net": 1007.52
    },
    "latestSevenDay": {
      ...
      "gross": 3508.3,
      "net": 3508.3,
      "arkTitleFamilyTransactions": 113,
      "arkTitleFamilyGross": 2437.85,
      "arkTitleFamilyNet": 2437.85,
      "arkTitleFamilyShareOfTransactionsPct": 68.5,
      "arkTitleFamilyShareOfRevenuePct": 69.5,
      "librariansTitleFamilyTransactions": 51,
      "librariansTitleFamilyGross": 1067.46,
      "librariansTitleFamilyNet": 1067.46,
      "librariansTitleFamilyShareOfTransactionsPct": 30.9,
      "librariansTitleFamilyShareOfRevenuePct": 30.4,
      "topTitlesByNet": [
        {
          "title": "The Ark - Season 3",
          "transactions": 109,
    ...
    "note": "Fresh Aug 4 aggregate export. Customer emails and individual customer rows are intentionally excluded. The full export covers 182 paid TVOD transactions / $3,794.08 net from 2026-07-05\u20132026-08-03. The Ark title family totals 121 transactions / $2,602.74; The Librarians title family totals 52 transactions / $1,070.45. Do not add this TVOD export to Visible Platform Sales until it is reconciled against Stripe, Roku, Apple, and other platform-specific transaction feeds.",
  ...
  "refreshAuditNotes": [
    ...
    "Aug 3 visits card fix: monthly visits badge restored to show up/down/equal vs previous 28 days while keeping the rolling 28-day date range visible.",
    "Aug 3 time baseline fix: restored launch-week GA4 baselines for Avg time per user, Avg time per session, and Total engaged hours using Apr 13-Apr 19, 2026 baseline values from historical dashboard data."
  ],
  "connectorStatus": {
  ...
  "audit": {
    "comparisonCardFix": {
      "appliedAt": "2026-08-03 14:08 PDT",
      "note": "Restored launch-week baselines for Time on Platform cards across both top-level and grouped scorecard structures; monthly visits explicitly compare against previous 28 days."
    }
  },
  "updateNotes": [
    "Aug 3 production fix: monthly visits now shows up/down versus the previous 28 days, and Time on Platform launch-baseline cards use the app-launch week as baseline."
  ]
};
...
function renderPurchases() {
  ...
  const tvodReconciliation = tvodPaidGross != null ? `
    <div class="sales-callout sales-callout-secondary">
      <span>Authoritative manual TVOD export</span>
      <strong>${fmt.number(tvodTxn.paidTransactions)} paid transactions / ${fmt.currency(tvodPaidGross)} gross</strong>
      <p>${escapeHtml(tvod.periodStart || '')}${tvod.periodStart && tvod.periodEnd ? '–' : ''}${escapeHtml(tvod.periodEnd || '')}. This is the DotStudios/Michael Johnson transaction export by title and device. Net after the refund shown in the export is ${fmt.currency(tvodNetIncludingRefunds)}.</p>
      ${tvodLatestGross != null ? `<p class="sales-net">Latest 7 days in the TVOD export: ${fmt.number(tvodTxn.latestSevenDayPaidTransactions)} paid transactions / ${fmt.currency(tvodLatestGross)} gross.</p>` : ''}
      <p class="sales-net">Reconciliation: the visible payment-source rollup below is ${fmt.currency(yearToDate.purchaseRevenue)} because it combines Stripe, Roku, and manual Apple snapshots only. The TVOD export is more complete for title-level sales, so these two numbers should not be added together.</p>
    </div>
  ` : '';
  $('#sales-summary').innerHTML = `
    ...
    <div class="sales-stat-grid">
      ...
      <div class="sales-stat">
        <span>${escapeHtml(thisWeek.label || 'Latest visible sales week')}</span>
