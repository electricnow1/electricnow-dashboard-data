(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    ...
    "plainEnglishInsights": [
      "Overall (June 15, 2026 refresh): GA4 complete-week usage advances to Jun 8-Jun 14, 2026; the prior complete week (Jun 1-Jun 7, 2026) is the comparison baseline. Measured platform audience was 7,282 GA4 active users for Jun 8-Jun 14, 2026 (excluding landing-page acquisition), with 13,850 sessions and a 78% engagement rate. New this run on the sales side: the June 15 Roku Sales Activity Report added two Purchase HD 15 sales (June 11 and June 13, $14.99 each), lifting combined visible platform sales to 52/$946.48. Google Ads is STALE this run (RESOURCE_EXHAUSTED rate limit); its last-good Jun 1-Jun 7, 2026 values are preserved, not zeroed.",
      ...
      "Paid acquisition: Meta spent $3,128.73 over May 31-Jun 6, 2026 driving 2,997 app downloads at $1.04 per download, with Android cheaper than iOS - cost per install stays in an acceptable band and the new GA4 week shows that downstream usage held up (engaged sessions and engagement rate did not regress), which is supportive of acquisition quality. Google Ads is STALE this run (RESOURCE_EXHAUSTED rate limit on the Jun 8-14 pull); its last successful pull (2026-06-11 14:40 PDT) covering Jun 1-Jun 7, 2026 reported $66.47 app-promotion cost and 124 conversions, and those figures are held as last-good, not zeroed. Important: this is a downstream-quality read only - we do NOT claim a true ROAS, because ad-server revenue attribution is unavailable and visible platform sales (Stripe + Roku + manual Apple) are not ad-attributed booked revenue.",
      "Targeting signal: Meta's Android campaigns remain materially cheaper than iOS ($0.89 vs $1.34 per download); spend continues to skew toward the more efficient platform.",
      ...
      "Visible platform sales (Stripe + Roku + manual Apple): 52 purchases and $946.48 year to date - Stripe 21/$439.79, Roku 18/$271.82, Apple 13/$234.87 gross. Adds Jun 11 and Jun 13 Roku sales; no double-counting. YouTube is NOT a platform sales source.",
      ...
      "Bottom line: the complete-week window advanced cleanly to Jun 8-Jun 14, 2026 with usage steady and no regression; Meta keeps buying installs at reasonable cost; visible sales rose to 52/$946.48 on two new Roku sales. Open items: a successful Google Ads pull (currently rate-limited) and ad-attributed revenue to prove downstream ROAS."
    ],
    "instrumentationGaps": [
    ...
    "salesSummary": {
      ...
      "roku": {
        ...
        "reportGenerated": "June 15, 2026 at 7:17 AM PDT",
        "baselineWindow": {
        ...
        "yearToDate": {
          ...
          "range": "Jan 1-Jun 15, 2026",
          "purchases": 18,
          "purchaseRevenue": 271.82,
          "developerRevShare": 217.42,
          "revenuePerPurchase": 15.1011,
          "payments": [
            {
              "date": "Jun 13",
        ...
        "note": "Roku-visible sales from the latest emailed Sales Activity Report (generated Jun 15, 2026). Year to date: 18 purchases / $271.82 gross (dev rev share $217.42). Adds the new Jun 11 and Jun 13 Purchase HD 15 ($14.99 each) sales; earlier rows (through Jun 7) were already recorded and are not double-counted."
      },
      "apple": {
      ...
      "sourceBreakout": [
        ...
        },
        {
          ...
          "purchaseRevenue": 271.82,
          "developerRevShare": 217.42,
          "detail": "Roku-visible sales from the Jun 15, 2026 Sales Activity Report; adds Jun 11 and Jun 13 Purchase HD 15."
        },
        {
          "source": "Apple App Store",
          "purchases": 13,
          "purchaseRevenue": 234.87,
          "developerRevShare": 164.39,
          "detail": "Manual Apple App Store snapshot (through Jun 14); Jun 13 (x2) and Jun 14 sales recorded."
        }
      ],
      "baselineWindow": {
        "label": "Launch baseline",
      ...
      "yearToDate": {
        ...
        "range": "Jan 1-Jun 15, 2026",
        "purchases": 52,
        "purchaseRevenue": 946.48,
        "developerRevShare": 821.6,
        "revenuePerPurchase": 18.2
      },
      "monthToDate": {
        "label": "Sales this month",
        "range": "Jun 1-Jun 14, 2026",
        "purchases": 9,
        "purchaseRevenue": 139.91,
        "developerRevShare": 104.41,
        "revenuePerPurchase": 15.55,
        "payments": [
          {
            "date": "Jun 10",
            "amount": 14.99,
      ...
      "note": "Visible platform sales show 52 purchases and $946.48 year to date, combining Stripe-visible payments, Roku-visible sales, and the manual Apple App Store snapshot. This run adds two new Roku Purchase HD 15 sales (Jun 11 and Jun 13). Still not total ElectricNOW sales: Google Play is separate and Apple is a manual snapshot. YouTube is a separate channel (estimated YouTube ad revenue only) and is NOT included here."
    },
    "contentUsage": {
    ...
    "plainEnglishSummary": {
      ...
      "bullets": [
        ...
        "Paid acquisition: Meta spent $3,128.73 over May 31-Jun 6, 2026 driving 2,997 app downloads at $1.04 per download, with Android cheaper than iOS - cost per install stays in an acceptable band and the new GA4 week shows that downstream usage held up (engaged sessions and engagement rate did not regress), which is supportive of acquisition quality. Google Ads is STALE this run (RESOURCE_EXHAUSTED rate limit on the Jun 8-14 pull); its last successful pull (2026-06-11 14:40 PDT) covering Jun 1-Jun 7, 2026 reported $66.47 app-promotion cost and 124 conversions, and those figures are held as last-good, not zeroed. Important: this is a downstream-quality read only - we do NOT claim a true ROAS, because ad-server revenue attribution is unavailable and visible platform sales (Stripe + Roku + manual Apple) are not ad-attributed booked revenue.",
        "App downloads (Apple manual snapshot): 926 downloads for Jun 8-Jun 14, 2026. This is App Store download activity, not paid sales and not GA4 active users.",
        "Sales (visible platform sales = Stripe + Roku + manual Apple): 52 purchases and $946.48 year to date - Stripe 21/$439.79, Roku 18/$271.82, and Apple 13/$234.87 gross. This run added two new Roku Purchase HD 15 sales (Jun 11 and Jun 13); earlier rows were already counted and are not double-counted. YouTube is separate (estimated YouTube ad revenue only) and not in this total.",
        ...
        "YouTube (separate channel, estimated ad revenue only): the ElectricNOW YouTube channel now has a complete week for Jun 8-Jun 14, 2026 - 164,595 views, ~74,521 hours watched, average view duration 27m 11s, and ~$3,243.85 estimated YouTube ad revenue on 877,734 ad impressions (136,472 monetized playbacks). Net subscribers +179. This is estimated YouTube ad revenue on a separate YouTube channel - it is NOT a platform sales source and is NOT included in Visible Platform Sales; ad impressions are a distinct YouTube metric, not GA4 ad events.",
        "Bottom line: the GA4 complete-week window advanced cleanly to Jun 8-14 with usage steady and no regression, Meta keeps buying installs at reasonable cost, and visible sales rose to 52/$946.48 on the two new Roku sales. Open items: Google Ads needs a successful (non-rate-limited) pull to refresh paid-search spend, and true ROAS remains unprovable until ad-attributed revenue is available."
      ]
    },
    "youtubeSummary": {
