(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    ...
    "plainEnglishInsights": [
      ...
      "Paid acquisition - simple read: the ads remain promising and cost per install is acceptable, but we still need proof that paid installs become durable viewers. Meta spent $3,146.72 from May 24-May 30 and drove 3,259 reported downloads at about $0.97 blended CPI. Android remains cheaper than iOS in the Meta report.",
      ...
      "Apple App Store Connect now adds manual download context: Free iOS/watchOS/tvOS downloads were 3,102 for May 18-May 31, 2026, up 51.1%, with a daily average of 222. This is downloads only; it is not Apple sales and it is not counted as GA4 active users.",
      ...
      "Bottom line: the later GA4 refresh does not change the story dramatically, but it slightly improves the week’s usage picture. ElectricNOW appears to be growing modestly, paid acquisition is efficient enough to keep testing, and the biggest priority remains proving that acquired users return, watch longer, and eventually monetize."
    ],
    "instrumentationGaps": [
    ...
    "manualAppleDownloads": {
      ...
      "sourceDetail": "User-provided App Store Connect screenshot for Free iOS/watchOS/tvOS downloads. This is app download activity, not paid sales and not GA4 active users.",
      "capturedAt": "2026-06-01 22:32 PDT",
      "enteredAt": "2026-06-01 22:43 PDT",
      "uploadedAttachment": "uploaded_attachments/3010c4699dcb404a8bdf5c5a899f2b29/image.jpeg",
      "product": "ElectricNOW",
      ...
      "note": "Because this is a manual Apple Connect screenshot, it should be preserved until replaced by a newer screenshot or an Apple App Store Connect API integration."
    }
  };
