(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    "generatedAt": "2026-06-14 10:05 PDT",
    ...
    "plainEnglishInsights": [
      "Overall (June 14, 2026 refresh): GA4 complete-week usage remains Jun 1-Jun 7, 2026 because June 14 is mid-week and the next Mon-Sun week (June 8-14) is not complete yet, so platform-usage windows are intentionally held at the last complete week. Measured platform audience was 7,552 GA4 active users for Jun 1-Jun 7, 2026 (excluding landing-page acquisition), -2.7% vs the previous complete week. New this run: Apple downloads and sales were updated through June 12 from the latest App Store Connect screenshots - a June 11 Purchase HD 15 sale ($14.99), plus a June 6-12 downloads snapshot of 1,008 (the June 10 sale was already recorded and is not double-counted). Roku App Engagement is still stale - a newer report could not be retrieved, so the last good May 31-June 6 values are preserved (not zeroed). Paid acquisition is current to each source: Meta May 31-June 6 and Google Ads June 1-June 7.",
      ...
      "Visible platform sales (combined Stripe, Roku, and the manual Apple App Store snapshot): 47 purchases and $871.53 year to date - Stripe 21/$439.79, Roku 16/$241.84 ($193.44 developer revenue share), and Apple 10/$189.90 ($132.92 est. net), now including the June 11 Apple Purchase HD 15 ($14.99). This is visible platform sales, not total company-wide sales: Google Play is separate and Apple is a manual snapshot.",
    ...
    "salesSummary": {
      ...
      "apple": {
        ...
        "snapshotRange": "Manual Apple App Store screenshots through Jun 12, 2026",
        "platformFeePct": 30,
        "estimatedNetPct": 70,
        "baselineWindow": {
        ...
        "yearToDate": {
          ...
          "purchases": 10,
          "purchaseRevenue": 189.9,
          "developerRevShare": 132.92,
          "revenuePerPurchase": 18.99,
          "payments": [
            {
              "date": "Apr 16",
              "amount": 29.98,
        ...
        "mix": [
          ...
          },
          {
            ...
            "purchases": 4,
            "purchaseRevenue": 59.96,
            "developerRevShare": 41.97
          },
          {
        ...
        "note": "Apple App Store screenshots show $189.90 gross in-app purchase sales manually entered so far, or approximately $132.92 after Apple’s 30% platform fee. Includes the Jun 11, 2026 Purchase HD 15 ($14.99) from the latest App Store Connect screenshot (Jun 6-Jun 12 window; the Jun 10 sale was already recorded and is not double-counted). These figures remain manual until Apple App Store Connect API reporting is connected."
      },
      "sourceBreakout": [
        {
          "source": "Stripe",
        ...
        },
        {
          ...
          "purchaseRevenue": 189.9,
          "developerRevShare": 132.92,
          "detail": "Manual Apple App Store snapshot; includes the Jun 11, 2026 Purchase HD 15 ($14.99) from the latest App Store Connect screenshot (Jun 10 already recorded)."
        }
      ],
      "baselineWindow": {
        "label": "Launch baseline",
      ...
      "yearToDate": {
        ...
        "range": "Jan 1-Jun 14, 2026",
        "purchases": 47,
        "purchaseRevenue": 871.53,
        "developerRevShare": 326.36,
        "revenuePerPurchase": 18.54
      },
      "monthToDate": {
      ...
      "note": "Visible platform sales show 47 purchases and $871.53 year to date, combining Stripe-visible payments, Roku-visible sales, and the manual Apple App Store snapshot. Apple gross in the snapshot is $189.90 (est. net $132.92 after Apple’s 30% fee). Still not total ElectricNOW sales: Google Play is separate and Apple is a manual snapshot."
    },
    "contentUsage": {
    ...
    "manualAppleSalesUpdate": {
      "updatedAt": "2026-06-14T17:05:00+00:00",
      "source": "manual_apple_sales.json updated with Jun 11 sale; preserved across refresh",
      "totalManualAppleEntries": 6,
      "note": "6 manual entries: May 13, May 18 (2), May 25, Jun 10, Jun 11 (Purchase HD 15, $14.99 gross)."
    },
    "googleAdsSummary": {
    ...
    "manualAppleDownloads": {
      ...
      "capturedAt": "2026-06-14 09:58 PDT",
      "enteredAt": "2026-06-14 10:05 PDT",
      "uploadedAttachments": [
        "uploaded_attachments/ae9c6fbb4b3745d8928f34d7909a1d7c/image-1.jpeg"
      ],
      "product": "ElectricNOW",
      "platform": "Free iOS/watchOS/tvOS",
      "period": "Jun 6-Jun 12, 2026",
      "start": "2026-06-06",
      "end": "2026-06-12",
      "downloads": 1008,
      "displayDownloads": "1,008",
      "dailyAverage": 144,
      "daily": [
        {
          "date": "2026-06-06",
      ...
      "note": "Manual Apple Connect screenshot. Daily U.S. downloads total 1,008 for Jun 6-Jun 12, 2026 (June 12 = 140). Preserved until replaced by a newer screenshot or an Apple App Store Connect API integration."
    },
    "manualDataPatch": {
    ...
    "plainEnglishSummary": {
      ...
      "bullets": [
        ...
        "App downloads (Apple manual snapshot): 1,008 downloads for Jun 6-Jun 12, 2026 (June 12 = 140). This is App Store download activity, not paid sales and not GA4 active users.",
        "Sales (visible platform sales = Stripe + Roku + manual Apple): 47 purchases and $871.53 year to date - Stripe 21/$439.79, Roku 16/$241.84, and Apple 10/$189.90 gross (est. net $132.92 after Apple's 30% fee), now including the June 11 Apple Purchase HD 15 ($14.99).",
        ...
        "Bottom line: usage is steady on the last complete week with no regression, paid spend keeps buying installs at reasonable cost, and visible sales rose to 47/$871.53 with the new Apple sale. The open item is still proving downstream viewing depth from paid installs, plus refreshing Roku App Engagement once its attachment is available."
      ]
    }
  };
