(() => {
  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    "generatedAt": "2026-07-03 11:55 PDT",
    ...
    "youtubeSummary": {
      ...
      "periodNote": "Monday-Sunday week of Jun 22-28; the YouTube Analytics connector's daily rows and the weekly totals both cover Jun 22-27 (6 days). Jun 28 is not yet finalized by the connector (typical multi-day reporting lag), so this is the latest available data. The vs-prior-full-week deltas compare these 6 days against the prior full week (Jun 15-21) and are therefore preliminary.",
      ...
      "dataFreshnessNote": "Latest available: Jun 22-27, 2026 (6 days). Jun 28 pending YouTube Analytics finalization; not fabricated."
    },
    "appTrendNote": "This trend charts total app sessions in green (a reliable daily activity signal) alongside daily active users in blue - both rose into Sun Jun 28, 2026. Heads-up: GA4's separate “engaged sessions” metric shows an isolated one-day dip on Jun 28 (a GA4 engaged-session classification anomaly, not a real engagement collapse); time spent in the app actually rose +1.8% that week. Engaged-session rate is tracked in the scorecards above."
  };
