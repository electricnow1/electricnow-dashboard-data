  ...
  window.ELECTRICNOW_DASHBOARD_DATA = {
    ...
    "scorecards": [
      ...
      },
      {
        ...
        "deltaType": "percent",
        "format": "number",
        "context": "People using the Apple/iOS or Android app streams (GA4 property 497892271, streams 12950551103 + 12982344897); Apple TV is not yet split from the Apple/iOS stream. Value shown is the last good stream-level reading (week of Jun 8-14). The stream-level app-usage source was not refreshed in this run, so the vs-previous-7-days comparison is unavailable (not 0%). It will repopulate on the next full stream-level (source) refresh.",
      ...
      },
      {
        ...
        "deltaType": "percent",
        "format": "number",
        "context": "GA4 sessions on the Apple/iOS and Android app streams (property 497892271, streams 12950551103 + 12982344897). Value shown is the last good stream-level reading (week of Jun 8-14). The stream-level app-usage source was not refreshed in this run, so the vs-previous-7-days comparison is unavailable (not 0%). It will repopulate on the next full stream-level (source) refresh.",
        "currentSourceNote": "Preserved: no fresh GA4 source for this metric in the Jun 8-14 run.",
        "comparisonUnavailable": true
      },
      {
